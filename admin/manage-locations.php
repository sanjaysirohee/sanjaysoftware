...
">
                        ...
                        <h6 class="card-subtitle"><a class='btn btn-primary' href='add-location.php'>Add Location</a></h6>
                        <div class="table-responsive m-t-40">
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    <?php
                                    $fetch_blog = mysqli_query($con, "select * from tbl_location order by id desc");
                                    while ($res_blog = mysqli_fetch_array($fetch_blog)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../admin/images/locations/<?= $res_blog['image']; ?>"
                                                    width="80" /></td>
                                            <!-- <td>
                                                <?= substr($res_blog['description'], 0, 150); ?>
                                            </td> -->
                                           
                                            <td>
                                                <span class="badge badge-<?= $res_blog['status'] == 1 ? 'success' : 'danger'; ?>">
                                            ...
                                            <td><a href="javascript:void(0)"
                                                    onclick="warning('add-location.php?location_id=<?= $res_blog['id']; ?>','Do You Want TO Update ?')"
                                                    title="Edit"><i class="icon-pencil"></i> </a>

                                                <a href="javascript:void(0)"
                                                    onclick="warning('controller/auth.php?location_id=<?= $res_blog['id']; ?>','Do You Want To Delete ?')"
